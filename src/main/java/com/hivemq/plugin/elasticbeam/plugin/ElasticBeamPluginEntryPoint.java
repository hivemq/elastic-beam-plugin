...
import com.hivemq.plugin.elasticbeam.callbacks.AddHTTPHeartbeatOnStartup;
 ...
 */
public class ElasticBeamPluginEntryPoint extends PluginEntryPoint {


    private AddHTTPHeartbeatOnStartup addHTTPHeartbeatOnStartup;

    @Inject
    ElasticBeamPluginEntryPoint(final AddHTTPHeartbeatOnStartup addHTTPHeartbeatOnStartup) {
